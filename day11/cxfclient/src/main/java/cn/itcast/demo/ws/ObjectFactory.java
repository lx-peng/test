 ...
 * generated in the cn.itcast.demo.ws package. 
...
public class ObjectFactory {
    ...
    private final static QName _Info_QNAME = new QName("http://ws.demo.itcast.cn/", "info");
    private final static QName _InfoResponse_QNAME = new QName("http://ws.demo.itcast.cn/", "infoResponse");

    /**
     * Create a new ObjectFactory that can be used to create new instances of schema derived classes for package: cn.itcast.demo.ws
     * 
     */
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://ws.demo.itcast.cn/", name = "info")
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://ws.demo.itcast.cn/", name = "infoResponse")
